...
{
	public sealed class BRhodiumX13
	{
		...
		private static readonly Lazy<BRhodiumX13> SingletonInstance = new Lazy<BRhodiumX13>(LazyThreadSafetyMode.PublicationOnly);
		...
		/// </summary>
		public static BRhodiumX13 Instance => SingletonInstance.Value;

		public static BRhodiumX13 Create()
		{
			return new BRhodiumX13();
		}
